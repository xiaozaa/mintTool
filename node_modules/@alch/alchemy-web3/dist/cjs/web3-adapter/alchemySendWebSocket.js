...
exports.makeWebSocketSender = void 0;
...
function makeWebSocketSender(ws) {
    ...
    ws.addEventListener("message", function (message) {
        ...
        if (!types_1.isResponse(response)) {
            return;
        }
    ...
    ws.addEventListener("down", function () {
        tslib_1.__spreadArray([], tslib_1.__read(contextsById)).forEach(function (_a) {
            var _b = tslib_1.__read(_a, 2), id = _b[0], _c = _b[1], request = _c.request, resolve = _c.resolve;
            if (isWrite(request)) {
    ...
    ws.addEventListener("reopen", function () {
        var e_1, _a;
        try {
            for (var _b = tslib_1.__values(contextsById.values()), _c = _b.next(); !_c.done; _c = _b.next()) {
...
exports.makeWebSocketSender = makeWebSocketSender;
...
function getCanonicalIdFromList(ids) {
    ...
    if (numberIds.length > 0) {
        return Math.min.apply(Math, tslib_1.__spreadArray([], tslib_1.__read(numberIds)));
    }
